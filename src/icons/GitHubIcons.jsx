export default function GitHubIcons(props) {
    if(props.icon==="dropdown")
        return <>
            <svg className={props.className} x="0px" y="0px" viewBox="0 0 14 8" fill="none">
                <path d="M1,1l6.2,6L13,1"></path>
            </svg>
        </>
    if(props.icon==="group")
        return <>
            <svg className={props.className} aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16">
    ...
    if(props.icon==="location")
        return <>
            <svg className={props.className} viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
    ...
    throw new Error(`GitHubIcons: ${props.icon} não é um ícone válido.`);
}